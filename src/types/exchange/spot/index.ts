...
export declare namespace ExchangeSpotTypes {
  export type SpotSnapshot<C extends ExchangeSpotChannel, E extends SpotExchange> = t.TypeOf<
    typeof ExchangeSpotTypes.DataTypes[C][E]['snapshot']
  >

  export type Data<C extends ExchangeSpotChannel, E extends SpotExchange> = t.TypeOf<
